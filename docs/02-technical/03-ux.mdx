...
UX emerged as a discipline of HCI. To start, the combination of Engineering and psychology formed Humans Factor Engineering (HFE), of which Industrial Design, Product Design, and HCI are subcategories. The divergence of HFE and HCI came after cognitive psychology became more and more influential and referenced in HCI literature and academia. Under HCI are interaction design, user experience, and UI design.
...
Visual hierarchy is the principle of arranging elements to show their order of importance or used to influence perception of elements in the order you want your users to view them.
