...
To elaborate, a user interface is the representation
of a system—the summation of all its input devices,
conceptual models, and interaction techniques—
with which a user interacts. User interface represents and reinforces the
user’s conceptual model of the system in concert
with the input device and interaction techniques, and presents affordances and constraints that
make it clear to the users how to achieve key tasks. This includes any number of modalities of interaction where data is transferred between the user and the computer system.
