...
General advice: Know key-performance indicators (KPIs) and how to measure them. Know how to create and conduct research plans. Know your research methods. Know how to analyze data. 
...
- <Question question='What is qualitative and quantitative research?*' />
...
- <Question question='What is the difference between attitudinal vs behavioral research?' />
...
> .. a vital outcome of research (not just the data that is gathered but the experiences we have in gathering it) is learning about what we didn't know that we didn't know. The most important insights often lie beyond the quesitons that we started with.
>
...
- Helps decide which problems, features are the highest priority and how you might go about solving them.
- Uncovers information crucial to the development process allowing you to scope out projects and plan the project road-map.
...
The research methods must be appropriately selected to answer to the research questions while taking in consideration the project timeline, budget, and the amount of synthesis required for that method versus another one. Research methods depend on the research goal, the stage that you’re at in the design process, and the available resources.

Start by asking good questions. Create a research plan with clear research goals, and hypothesis. Select reseach methods. Plan logistics. Recruit your research team. Analyze findings and synthesize insights. Report your findings.
...
There are a variety of different research methods used in UX. Instead of trying to remember all of the research methods, its better to understand the types of research methods, the type of data they result in, and when these categories of methods should be used. For example, quantitative vs qualitative, generative vs evaluative, formative vs summative research.
...
**Generative research** also known as exploratory research, are used to discover people’s motivations, pain points, behaviors, and more. Generative research helps identify and define a problem and offer opportunities to create and
explore new designs through research.

**Evaluative research** is used to evaluate, assess a product or concept, generally by collecting data such as KPIs or benchmarks that helps improve your solution. There are two types of evaluative research: formative & summative.
...
Formative and summative research are types of evaluative research - meaning both are tests methods used to evaluate and assess your product and its design. The difference again here is intention.

**Formative evaluations** focus on determining which aspects of the design work well or not, and why. These evaluations occur throughout a redesign and provide information to incrementally improve the interface. Formative evaluations help formulate new or existing designs.
...
Both methods are used in design validation.

##### References

- https://www.nngroup.com/articles/formative-vs-summative-evaluations/

### What is the difference between attitudinal vs behavioral research?
...
**Behavioral research is about what people do**. It involves direct observation of the actions that a person takes. Ethnographic studies, usability studies, A/B tests, and eye tracking studies are all examples of Behavioral Research methods. In UX, behavioral research and data is more important especially in usability studies.
...
- Cognitive bias in UX researchers can introduce biases during their interpretation of findings, behavior in user interviews, and from implicit bias in users.
- In user interviews, asking leading questions may point users to the type of answer you're looking for. Ask more open ended questions instead. Also, be careful about body language.
...
- If you feel strongly about a feature you are design or have any other conflicts of interest, you may consider removing yourself from the research, or be mindful and purposeful about framing questions from a neutral pov.
- Additionally, you could select methods that have a lower risk of bias such as direct observational studies.
- At the end of research methods, conduct a debrief and come to an agreement or alignment about research findings.
- As a project lead, try to be neutral and not judgemental. This allows your team to come to you and be able to talk freely without reservation.
