...
**Generative research** also known as exploratory research, is used to discover people’s motivations, pain points, behaviors, and more. Generative research helps identify and define a problem and offer opportunities to create and
...
Formative and summative research are types of evaluative research - meaning both are tests methods used to evaluate and assess your product and design. The difference again here is intention.
...
**Behavioral research is about what people do**. It involves direct observation of the actions that a person takes. Ethnographic studies, usability studies, A/B tests, and eye tracking studies are all examples of behavioral besearch methods. In UX, behavioral research and data is more important especially in usability studies.
