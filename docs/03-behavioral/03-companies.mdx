...
- Amazon wants you to have work that can be directly related to and applicable to their products. ie transactional flows.

### UX Designer

- Describe a time you demonstrated customer obsession.
...
- What would you do if someone on your team is not pulling their weight?
...
- Whiteboard/Design Challenges:
  ...
  - Redesign the Amazon.com homepage.
...
- How would you conduct a UX research study to improve UX on an Amazon page for books?
- Tell me about a time when you failed.
- If your interviewee was very stressed, what would you do?
...
- Tell me about a time when you had to dig deep to discover the root cause of a problem. What was the situation, how did you know you uncovered the real problem, and what was the outcome?
...
- Imagine that a team of engineers wants to know why certain users aren't engaging with a particular push feature. They plan to conduct a survey with six yes/no questions and one question that can be answered via text box. What would you tell them about their plan?
- Imagine you have 3 different UIs and you want to know which one is best, what would you do?
- How would you conduct user interviews if you were trying to test a particular interaction?
...
- How do you deal with pushback from upper management?
...
- Whiteboard Exercises:
  ...
  - There is a new residential skyscraper that also has a restaurant on top. Access to all apartments and the restaurant is secured behind a locked door. Design an interface that will be on the first floor and take the place of a door person.
...
- Select an app that you use and identify some usability issues. How would you increase engagement and present information if you only had two weeks? How would you analyze the data? Why was it designed this way? What would you change about it? What's a feature you can add to increase growth?
- Pick an app, let's say you work for that company. A bunch of users signed up for the app and then quickly left. How would you study it to determine why they left and how to get them back? What methods or processes would you use? Who would you try to talk to, and in the end what do you think your insights might be that you'd present to relevant stakeholder?. Also, let's say the stakeholders find your insights interesting, but have issues with the sample size/makeup, what would you say?
...
- Can you rate your statistical skills? Are you familiar with HLM, ANOVA, Growth models, ethnography, and interviews?
- How would you rate your experience with the following research methods? (Focus groups, In-depth interviews, surveys, etc.)
- If you are going to investigate the search function on Facebook, how do you do it? How to measure it? How do you measure the users' satisfaction? If the survey did not show a difference in satisfaction between two search algorithms, what you will do?
