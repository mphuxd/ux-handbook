...
You can find more examples <Link to="/behavioral/companies">here</Link>.
...
<img src='/img/bus-kiosk.jpg' alt='Starting design for the bus kiosk station exercise.' />
...
<img
  src='https://cdn1.vox-cdn.com/thumbor/neJR1Pjm2e9UG-Ac6IS8tAix33I=/cdn0.vox-cdn.com/uploads/chorus_asset/file/3461336/newark2.0.jpeg'
  alt='Example environment for the airport restaurant.'
/>
...
<details>
  <summary>Additional Constraints</summary>
  <li>
    What is the goal of the design? A: An efficient, hassle-free, and fun dining experience for busy
    travelers
  </li>
...
<details>
  ...
  <li>Hotels may already have reservations or are unavailable during certain dates.</li>
</details>

<details>
<summary>What I'm looking for</summary>
<li>How do users find the hotel? Search? Through navigation?</li> 
<li>If search, how do they handle forms for simple and complex inputs? Do they account for all necessary inputs like number of guests, adults, children, check-in and check-out date? Do they make fields required?</li>
...
<img src='/img/slots.jpg' alt='Example casino environment for the slot machine' />
...
<details>
  ...
  <li>The machine reads a card to withdraw and deposit the player's credits.</li>
...
<li>Does it have all the necessary controls & displays? Spin, increase & decrease bet amount, current bet amount, current balance, the previous amount won, amount won, volume controls, game information</li>
